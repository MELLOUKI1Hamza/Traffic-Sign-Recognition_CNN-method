...
path = "myData"  # dossier du data
labelFile = 'labels.csv'  # fichier avec nom des classes
batch_size_val = 50
epochs_val = 20
imageDimesions = (32, 32, 3)
testRatio = 0.2  # 200 images de test pour chaque 1000
...
############################### TEST SI LE NOMBRE D'IMAGES CORRESPOND AU NOMBRE DE LABELS
print("Data Shapes")
print("Train", end="");
...
############################### AFFICHER DES ECHANTILLONS D'IMAGES DE CLASSES
num_of_samples = []
cols = 5
...
############################### AFFICHER UN HISTOGRAMME QUI AFFICHE LE NOMBRE D'IMAGES DE CHAQUE CLASSE
...
############################### AUGMENTATAION DES IMAGES: RENDRE PLUS GENERALE
...
# AFFICHER DES ECHANTILLONS APRES AUGMENTATION
